     ...
     <div id="wrap">
      ...
      <div class="wrapper">
       ...
       <div id="content" class="bg-container">
                    ...
                    <div class="main-bar">
                        ...
                        <div class="col-lg-6 col-sm-8 col-12">
                            <ol class="breadcrumb float-right  nav_breadcrumb_top_align">
                                ...
                                <li class="active breadcrumb-item">Active User Grid</li>
                            </ol>
                        </div>
                        </div>
                    </div>
            ...
            <h3>Currently there are no users Active !!!!</h3>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body m-t-35" id="user_body">
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="${pageContext.request.contextPath}/admin/Adduserbyadmin" id="editable_table_new" class=" btn btn-default">
      ...
      <div id="editable_table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
         ...
         <div class="table-responsive">
            <table class="table table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid" aria-describedby="editable_table_info">
               <thead>
                  <tr role="row">
                     <th class="wid-10 sorting_asc" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-sort="ascending" aria-label="UserID activate to sort column descending" style="width: 76.1px;">UserId</th>
                     <th class="wid-25 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="Username: activate to sort column ascending" style="width: 185.7;">Username</th>
                     <th class="wid-20 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="First Name: activate to sort column ascending" style="width: 185.7px;">First Name</th>
                     <th class="wid-20 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="Last Name: activate to sort column ascending" style="width: 185.7px;">Last Name</th>
                     <th class="wid-25 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="Email Id: activate to sort column ascending" style="width: 188.9px;">Email Id</th>
                     <th class="wid-15 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="Contact No: activate to sort column ascending" style="width: 76.1px;">Contact No.</th>
                     <th class="wid-10 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="User Type: activate to sort column ascending" style="width: 85.9px;">User Type</th>
                     <th class="wid-20 sorting" tabindex="0" rowspan="1" colspan="1" aria-controls="editable_table" aria-label="Password: activate to sort column ascending" style="width: 85.9px;">Password</th>
               ...
               <tbody>
               <c:forEach var="users" items="${activeusers}">
                  <tr role="row" class="odd">
                     ...
                     <td>${users.email }</td>
                     <td class="center">${users.contactNo }</td>
                     <td class="center">${users.userType.userTypeText }</td>
                     <td class="center">${users.password }</td>
                     <td><a href="view_user.html" data-toggle="tooltip" data-placement="top" title="" data-original-title="View User"><i class="fa fa-eye text-success"></i></a>&nbsp; &nbsp;<a class="edit" data-toggle="tooltip" data-placement="top" title="" href="edit_user.html" data-original-title="Edit"><i class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp;<a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="" href="${pageContext.request.contextPath}/admin/deleteuser/${users.userId}" data-original-title="Delete"><i class="fa fa-trash text-danger"></i></a></td>
                  </tr>
              </c:forEach>
               </tbody>
            </table>
