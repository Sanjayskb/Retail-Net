...
//   flip js
    ...
    var uservalue = $('#uservalueid').val();
    var productvalue = $('#productvalueid').val();
    var messagevalue = $('#messagevalueid').val();
    var inquiriesvalue = $('#inquiriesvalueid').val();
    new CountUp("widget_countup1", 0, uservalue, 0, 5.0, options).start(); 
    new CountUp("widget_countup2", 0, productvalue, 0, 5.0, options).start();
    new CountUp("widget_countup3", 0, messagevalue, 0, 7.0, options).start();
    new CountUp("widget_countup4", 0, inquiriesvalue, 0, 9.0, options).start();
