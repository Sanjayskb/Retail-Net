...
// -=========================end main chat js========================
    ...
    $("form#main_input_box").submit(function(event) {
        ...
        //var twoButton = "<div class='col-3 showbtns todoitembtns'>" + editButton + striks + deleteButton + "</div>";
        var badgeClass = $('#btn_color').data('badge');
        var abc = $("#custom_textbox").val();
       $(".list_of_items").prepend("<div class='todolist_list showactions px-3'><div class='row'><div class='col-9 nopad custom_textbox1'><div class='todo_mintbadge'" + badgeClass + "></div><div class='todoitemcheck'>" + checkBox + "</div><div class='todotext todoitem'>" + abc + "</div></div><div class='col-3 showbtns todoitembtns'>" + editButton + striks + deleteButton + "</div><span class='seperator'></span></div>");
        $("#custom_textbox").val();
        $('#btn_color').css("color", "#fff");
        return false;
    });
