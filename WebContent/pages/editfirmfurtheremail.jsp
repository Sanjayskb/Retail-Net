...
<div class="a-section a-spacing-top-large">
  <div class="a-box"><div class="a-box-inner">
    <div class="a-row a-spacing-base">
      Use the form below to change the  Firm e-mail address for your Amazon account.  Use the new address next time you log in or place an order.
    </div>
    ...
    <form method="post" novalidate="" action="${pageContext.request.contextPath}/user/editfirmfurtheremailaction">
        ...
        <div class="a-section">
          ...
          <div class="a-row">
            <div id="ap_email_old" class="a-section a-padding-mini">
             <c:out value="${firm.firmEmail }"></c:out>
            </div>
          </div>
        </div>
        ...
        <div class="a-row">
          <label for="ap_email_new" class="a-form-label">
            ...
            <div class="a-row">
              ...
              <input type="email" id="firmEmail" autocomplete="off" name="firmEmail" tabindex="1" class="a-input-text a-width-large">
            </div>
