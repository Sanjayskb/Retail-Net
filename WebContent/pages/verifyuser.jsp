		...
		<div class="container">
				...
				<div class="text-center">
					<div class="login_form_inner register_form_inner">
                        ...
                        <form action="${pageContext.request.contextPath}/user/verifyuserAction"  method="Post"
                          class="form-group ">
                        <div class="bg-white login_content login_border_radius">
                            <div class="form-group">
                                <label > Enter Code you received in email </label>
                                <div class="input-group">
                            <span class="input-group-addon "><i
                                    class="fa fa-key text-primary"></i></span>
                                    <input type="text" class="form-control "
                                           id="randomnumber" name="randomnumber" placeholder="Verification Code">
                                </div>
                            </div>
