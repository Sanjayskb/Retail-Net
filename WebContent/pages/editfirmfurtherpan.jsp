...
<div id="auth-alert-window" class="a-box a-alert a-alert-error a-spacing-base" aria-live="assertive" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">There was a problem</h4><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
  <ul class="a-unordered-list a-vertical auth-error-messages">
    <li id="auth-phoneNumber-missing-alert"><span class="a-list-item">Please enter a valid Pan number </span></li>
    <li id="auth-phoneNumber-invalid-phone-alert"><span class="a-list-item">Please enter a valid Pan number </span></li>
  </ul>
</div></div></div>
...
<form id="auth-change-phone" method="post" novalidate="" action="${pageContext.request.contextPath}/user/editfirmfurtherpanaction">
  ...
  <div class="a-row">
        ...
        <div class="mobile-number-container">
          ...
          <input type="hidden" name="furtheraction" value="editphone">
            <input type="tel" maxlength="50" id="panNo" name="panNo" tabindex="1" class="a-input-text a-span12 a-spacing-base auth-required-field auth-require-phone-validation" data-validation-id="phoneNumber">
          </div>
